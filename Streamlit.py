...
if task == "Sentiment Classification":
    ...
    if new_review_text.strip():
        ...
        if model_option == "Perceptron":
            with open(r'C:\Users\lamiy\OneDrive\Desktop\Deep_learning_pred\Deep-Prediction-Hub\Perceptron.pkl', 'rb') as file:
                model = pickle.load(file)
        elif model_option == "Backpropagation":
            with open(r'C:\Users\lamiy\OneDrive\Desktop\Deep_learning_pred\Deep-Prediction-Hub\BackPropagation.pkl', 'rb') as file:
                model = pickle.load(file)
        elif model_option == "DNN":
            model = load_model(r'C:\Users\lamiy\OneDrive\Desktop\Deep_learning_pred\Deep-Prediction-Hub\Deeplearning.keras')
        elif model_option == "RNN":
            model = load_model(r'C:\Users\lamiy\OneDrive\Desktop\Deep_learning_pred\Deep-Prediction-Hub\RNN.keras')
        elif model_option == "LSTM":
            model = load_model(r'C:\Users\lamiy\OneDrive\Desktop\Deep_learning_pred\Deep-Prediction-Hub\LSTM.keras')
    ...
    if uploaded_file is not None:
        ...
        model = load_model(r'C:\Users\lamiy\OneDrive\Desktop\Deep_learning_pred\Deep-Prediction-Hub\CNN.keras')
